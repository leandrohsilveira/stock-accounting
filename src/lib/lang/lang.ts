import { createImperativeTranslator, I18nStore } from '@i18nlite/core'
...
export function createTranslator<T extends Record<string, string>>(literals: Record<Languages, T>) {
  return createImperativeTranslator(store, literals)
}
